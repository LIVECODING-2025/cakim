    ...
    <div class="col-lg-6 col-md-8">
      <div class="profile-card text-center">
        ...
        <div class="text-start px-3">
          ...
          <div class="row mb-3">
            <div class="col-5 text-end info-label">Email:</div>
            <div class="col-7 info-value"><?= htmlspecialchars($user['email']) ?></div>
          </div>
          <div class="row mb-3">
            <div class="col-5 text-end info-label">No. HP:</div>
            <div class="col-7 info-value"><?= htmlspecialchars($user['phone']) ?></div>
          </div>
          <div class="row mb-3">
            <div class="col-5 text-end info-label">Dibuat pada:</div>
            <div class="col-7 info-value"><?= htmlspecialchars($user['created_at']) ?></div>
          </div>
        </div>

        <div class="d-flex justify-content-center gap-3 mt-4">
          <a href="edit_profile.php?id=<?= $id_user ?>" class="btn btn-custom">
